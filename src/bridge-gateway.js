...
function getClientToolsPrompt(tools) {
  ...
  const promptLines = [
    '========================================================================',
    'YOU ARE A TEXT-ONLY API MODEL. YOU HAVE NO INTERNAL TOOLS.',
    '',
    '⚠️  CRITICAL — READ BEFORE ANYTHING ELSE:',
    'You are running INSIDE A WEB BROWSER as a text-generation API.',
    'You do NOT have access to: Python sandbox, code interpreter, web search,',
    'file download widgets, image generation, or ANY built-in Meta AI tools.',
    'DO NOT USE THEM. DO NOT ACTIVATE THEM. They do not exist in this context.',
    'If you try to use them, the request will hang and break the agent.',
    '',
    'THE ONLY WAY TO DO ANYTHING is to output XML <tool_call> blocks in plain text.',
    'A local executor on the user\'s machine reads your text, runs the tools,',
    'and sends the results back. You just output text — nothing more.',
    '',
    'ABSOLUTE RULES:',
    '1. NEVER use Python, code interpreter, web search, or Meta AI built-in tools.',
    '2. To create/read/edit files or run commands: output a <tool_call> XML block.',
